...
//                     autoComplete="name"
//                     style={{
//                       WebkitBoxShadow: '0 0 0 1000px #15151f inset',
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full bg-[#15151f] border ${
                      error.name ? "border-red-500/50" : "border-[#2a2a3a]"
                    } rounded-lg px-4 py-3.5 text-white text-sm placeholder-[#2a2a3a] focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition-all duration-200`}
                    autoComplete="name"
                    style={{
                      WebkitBoxShadow: "0 0 0 1000px #15151f inset",
                      WebkitTextFillColor: "white",
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full bg-[#15151f] border ${
                      error.email ? "border-red-500/50" : "border-[#2a2a3a]"
                    } rounded-lg px-4 py-3.5 text-gray-600 text-sm placeholder-gray-400 focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition-all duration-200`}
                    style={{
                      WebkitBoxShadow: "0 0 0 1000px #15151f inset",
                      WebkitTextFillColor: "white",
                    }}
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full bg-[#15151f] border ${
                      error.password ? "border-red-500/50" : "border-[#2a2a3a]"
                    } rounded-lg px-4 py-3.5 pr-12 text-white text-sm placeholder-[#2a2a3a] focus:outline-none focus:border-purple-500 focus:ring-1 focus:ring-purple-500 transition-all duration-200`}
                    autoComplete="new-password"
                    style={{
                      WebkitBoxShadow: "0 0 0 1000px #15151f inset",
                      WebkitTextFillColor: "white",
